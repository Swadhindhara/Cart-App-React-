...
const SingleProduct = () => {
  ...
  return (
    <div className="container mx-auto  flex-col mt-12 md:mt-24 ">
      <div className=" flex justify-center items-center py-[100px] md:flex-row flex-col mt-[-30px] md:mt-0  p-6 border-2  rounded-lg shadow-xl mr-2 ml-2">
      <button className="font-bold ml-6 mt-[-30%] ml-[-100%] md:ml-[-10px] md:mt-[-38%]" onClick={() => {history(-1)}}> <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 0 512 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 288 480 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-370.7 0 73.4-73.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-128 128z"/></svg> </button>
